...
if page == "Dashboard":
    ...
    st.info("App settings page placeholder for v1.2.8. We can add business name, default cure days, default units, and label settings here next.")
